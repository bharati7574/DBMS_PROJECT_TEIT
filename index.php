	...
	<!-- Carousel items -->
        ...
        <div class="item">
            ...
            <div class="carousel-caption" color="white">
                <p><h1><color="white">AgroCulture</color></h1></p>
            </div>
        </div>
    </div>
    ...
    <a class="carousel-control right" href="#myCarousel" data-slide="next">
		...
		<div class="footer-center">
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:snehallondhe298@gmail.com" style="color:white">demo@demo.com</a></p>
			</div>
		</div>
